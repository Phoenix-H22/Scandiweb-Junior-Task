  ...
  return (
    <>
      <div
        ...
        className={cn(
          "fixed left-0 bottom-0 z-40 bg-black/30 w-screen h-[calc(100vh-80px)] lg:h-[calc(100vh-80px)]",
          open ? "block" : "hidden"
        )}
      />
      <div
        ...
        className={cn(
          "absolute right-2 top-[53px] z-50 text-left max-h-[500px] h-auto sm:h-[633px] w-[280px] sm:w-[400px] bg-white shadow-lg p-6 overflow-y-auto",
          open ? "block" : "hidden"
        )}
      >
